...
//        ApplicationContext context=new ClassPathXmlApplicationContext ( "spring.xml" );
        //从配置类中读取
        ApplicationContext context=new AnnotationConfigApplicationContext ( com.programmer.config.IocConfig.class);
...
//        ProgrammerServiceImpl2 programmerService2 =context.getBean ( ProgrammerServiceImpl2.class );
       ProgrammerServiceImpl1 programmerService1 =context.getBean ( ProgrammerServiceImpl1.class );
        programmerService1.call ();
        programmerService1.print ();
